...
Feedstock license: [BSD-3-Clause](https://github.com/conda-forge/vaex-ml-feedstock/blob/master/LICENSE.txt)
...
<table><tr><td>All platforms:</td>
    <td>
      <a href="https://dev.azure.com/conda-forge/feedstock-builds/_build/latest?definitionId=7057&branchName=master">
        <img src="https://dev.azure.com/conda-forge/feedstock-builds/_apis/build/status/vaex-ml-feedstock?branchName=master">
      </a>
    </td>
  </tr>
</table>
...
Once the `conda-forge` channel has been enabled, `vaex-ml` can be installed with:

```
conda install vaex-ml
```

It is possible to list all of the versions of `vaex-ml` available on your platform with:
